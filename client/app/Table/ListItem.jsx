import { ListItem, TableCell, TableRow } from '@mui/material'
import GetReq from '../Functions/GetReq'


export async function ListItem() {
    
    let items = await GetReq(`http://localhost:5000/api/buy_price/buff_price/item_base/1/min_price1=20/min_price2=1/count=300/sort=asc`)

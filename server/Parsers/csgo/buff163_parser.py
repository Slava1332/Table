    ...
    for j in range(20,260):
        ...
        for i in range(80):
            ...
            with conn.cursor() as cursor:
                cursor.execute(
                    f"UPDATE item_base SET buff_price = {price} where hash_name = '{hash_name}'"
                )
